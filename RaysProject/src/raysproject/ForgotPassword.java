...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(pswd_tf, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, 260, 26));
        ...
        create_bt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/changepswd (1).png"))); // NOI18N
        ...
        jPanel1.add(create_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 460, -1, 35));
        ...
        jPanel1.add(use_tf, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 110, 260, 27));
        ...
        rep_tf.setEditable(false);
        rep_tf.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel1.add(rep_tf, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 410, 260, 26));
        ...
        jPanel1.add(ans_tf, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 260, 27));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel10.setText("ANSWER");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 220, -1, -1));

        sec_box.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        sec_box.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"What was your favorite subject in high school?", "What is the name of your first pet?", "What high school did you attend?", "What was your favorite food as a child?", "Where did you go on your favorite vacation as a child?" }));
        ...
        jPanel1.add(sec_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 180, 260, 30));
        ...
        jPanel1.add(frg_lb, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 310, 60));
        ...
        clear_bt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/clear (1).png"))); // NOI18N
        ...
        jPanel1.add(clear_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 460, 110, 35));
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/repl_logo_(1)-med.png"))); // NOI18N
        jPanel1.add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 50, 150, 120));
        ...
        jPanel1.add(hint, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 490, 120, 30));
        ...
        jPanel1.add(show_pswd, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 330, 30, 30));
        ...
        jPanel1.add(hide_pswd, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 330, 30, 30));
        ...
        jLabel1.setText("*");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 300, 20, -1));
        ...
        jPanel1.add(pswd_lb, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 360, 240, -1));
    ...
    private void pswd_tfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_pswd_tfFocusLost
        ...
        if(!(str.equals("*Field is Mandatory")||str.equals("*Invalid Input")))
    ...
    private void rep_tfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_rep_tfFocusLost
        ...
        if(str.length()<8)
            mismatch_lb.setText("*Contains at least 8 charcters!");
...
//        String u-id,sec_qus,sec_ans,pasw;
        boolean chk=true;
        if(use_tf.getText().equals("*Field is Mandatory")||ans_tf.getText().equals("*Field is Mandatory")||pswd_tf.getPassword().equals("*Field is Mandatory")||rep_tf.getPassword().equals("*Field is Mandatory")||pswd_lb.getText().equals("*Contains at least 8 charcters!")||mismatch_lb.getText().equals("*Contains at least 8 charcters!"))
            chk=false;
        else if(use_tf.getText().isEmpty()||ans_tf.getText().isEmpty()||pswd_tf.getPassword().toString().isEmpty()||rep_tf.getPassword().toString().isEmpty())
            chk=false;
        Check();        
        if(chk){
            try{
                stmt=con.prepareStatement("select sec_qus,sec_ans from signup where u_id=?",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);
                stmt.setString(1, use_tf.getText());
                rs=stmt.executeQuery();
                if(rs.next()){
                    if(!(sec_box.getSelectedIndex()==rs.getInt(1))){
...
//    public void zerocheck(JTextField c){
...
//       rep_tf.setEchoChar('*');
    ...
    public void Check(){
        if(use_tf.getText().equals("*Field is Mandatory")||use_tf.getText().isEmpty())
            use_tf.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.RED));
//        if(sec_box.getSelectedIndex()==0)
//            sec_box.setBorder(new LineBorder(Color.RED));
        if(ans_tf.getText().equals("*Field is Mandatory")||ans_tf.getText().isEmpty())
            ans_tf.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.RED));
        if(pswd_tf.getPassword().equals("*Field is Mandatory")||pswd_tf.getPassword().length==0)
            pswd_tf.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.RED));
        if(rep_tf.getPassword().equals("*Field is Mandatory")||rep_tf.getPassword().length==0)
            rep_tf.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.RED));
    }
