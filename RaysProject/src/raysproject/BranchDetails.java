...
//        ser_tf.setVisible(false);
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(54, 18, 100, -1));

        br_code.setEditable(false);
        kGradientPanel1.add(br_code, new org.netbeans.lib.awtextra.AbsoluteConstraints(158, 13, 277, 30));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Date");
        kGradientPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(565, 11, 47, 30));

        cur_dt.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                cur_dtFocusLost(evt);
            }
        });
        kGradientPanel1.add(cur_dt, new org.netbeans.lib.awtextra.AbsoluteConstraints(616, 13, 277, 30));
        ...
        add_bt.setBackground(new java.awt.Color(51, 102, 255));
        add_bt.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        add_bt.setForeground(new java.awt.Color(255, 255, 255));
        add_bt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/add2.png"))); // NOI18N
        add_bt.setText("ADD");
        ...
        can_bt.setBackground(new java.awt.Color(255, 51, 51));
        can_bt.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        can_bt.setForeground(new java.awt.Color(255, 255, 255));
        can_bt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/refresh (1).png"))); // NOI18N
        can_bt.setText("REFRESH");
        ...
        sta_box.setNextFocusableComponent(dist_tf);
        ...
        dist_tf.setNextFocusableComponent(add_bt);
        dist_tf.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                dist_tfFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                dist_tfFocusLost(evt);
            }
        });
        dist_tf.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                dist_tfKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(sta_box, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addComponent(jLabel15)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(can_bt)
                                    .addComponent(dist_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addGap(48, 48, 48)
                        .addComponent(mail_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(42, 42, 42)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(dist_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10)
                            .addComponent(jLabel15)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGap(39, 39, 39)
        ...
        kGradientPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 49, 943, -1));
        ...
        kGradientPanel2.add(ser_box, new org.netbeans.lib.awtextra.AbsoluteConstraints(77, 80, 220, 40));

        ser_bt.setBackground(new java.awt.Color(102, 102, 255));
        ...
        kGradientPanel2.add(ser_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 80, -1, 40));
        kGradientPanel2.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 45, 1045, 10));

        del_bt.setBackground(new java.awt.Color(255, 51, 51));
        ...
        kGradientPanel2.add(del_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 160, 100, 30));

        upd_bt.setBackground(new java.awt.Color(102, 102, 255));
        ...
        kGradientPanel2.add(upd_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 160, 110, 30));
        ...
        kGradientPanel2.add(ser_cb, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, 230, 40));
        ...
        kGradientPanel2.add(ref_bt, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 80, -1, 40));
        ...
        tab2.addTab("Branch Service Form", jPanel2);

        getContentPane().add(tab2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 970, 490));
...
//        }
    ...
    private void dist_tfKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dist_tfKeyTyped
        keycheck(dist_tf,evt);
    }//GEN-LAST:event_dist_tfKeyTyped

    private void dist_tfFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_dist_tfFocusLost
        flcheck(dist_tf);
    }//GEN-LAST:event_dist_tfFocusLost

    private void dist_tfFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_dist_tfFocusGained
        con_tf.setBorder(new LineBorder(Color.BLACK));
        fgcheck(dist_tf);
    }//GEN-LAST:event_dist_tfFocusGained
...
//            System.out.println(bcode);
        if(bran_tf.getText().equals("*Field is Mandatory")||brc_tf.getText().equals("*Field is Mandatory")||con_tf.getText().equals("*Field is Mandatory")||adds_tf.getText().equals("*Field is Mandatory")||dist_tf.getText().equals("*Field is Mandatory"))
        chk=false;
        else if(bran_tf.getText().isEmpty()||brc_tf.getText().isEmpty()||con_tf.getText().isEmpty()||adds_tf.getText().isEmpty()||dist_tf.getText().isEmpty())
        chk=false;
        Check();
//Data entry in table
        if(chk){
            try {
                ...
                stmt.setString(2, bran_tf.getText().toUpperCase());
                stmt.setString(3, brc_tf.getText().toUpperCase());
                if(mail_tf.getText()==null)
                    stmt.setString(4, "");
                else
                    stmt.setString(4, mail_tf.getText().toUpperCase());
                stmt.setString(5, adds_tf.getText().toLowerCase());
                stmt.setString(6, con_tf.getText());
                stmt.setString(7, dist_tf.getText().toUpperCase());
                stmt.setString(8, stt.toUpperCase());
                stmt.executeUpdate();
                bcode=bcode+1;
                autogen();
            ...
            if (str.endsWith(".in") || str.endsWith(".com"))
            {
                if(str.contains("@"))
                {
                    ...
                    if (index2==(index1+1))
                    {
                        ...
                        Toolkit.getDefaultToolkit().beep();
                        mail_tf.setText("*Please enter a valid email Id!");
                        mail_tf.setForeground(Color.red);
                    }
//                    else
//                    mail_tf.setText("");
                }
...
//            System.out.println("hii");
    ...
    private void adds_tfKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_adds_tfKeyTyped
        char ch=evt.getKeyChar();
        if((evt.getKeyChar()==' '||evt.getKeyChar()=='.'||evt.getKeyChar()==9) && adds_tf.getCaretPosition()==0)
        {
            evt.consume();
            Toolkit.getDefaultToolkit().beep();
        }
    ...
    private void del_btActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_del_btActionPerformed
            for(byte i=0;i<table.getRowCount();i++)
            {
                if(model.getValueAt(i,8).toString().equals("true")){
                    ...
                    if(up==0){
                        try {
                            stmt=con.prepareStatement("delete from branch_details where bcode=?");
    ...
    private void upd_btActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_upd_btActionPerformed
            for(byte i=0;i<table.getRowCount();i++)
            {
                if(model.getValueAt(i,8).toString().equals("true")){
                    ...
                    if(up==0){
                            try {
                                String url="update branch_details set bname=?,bcont_pr=?,email=?,badd=?,phno=?,dist=?,state1=? where bcode=?";
...
//        ser_cb.removeItemAt(ser_cb.getSelectedIndex());
...
//        if(ser_cb.getSelectedItem().toString().isEmpty())
//            System.out.println("hii");
        try {
...
//            model.setRowCount(0);
    ...
    private void cur_dtFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_cur_dtFocusLost
//        cur_dt.getDateFormatString();
//        cur_dt.get
//System.out.println(cur_dt.getDate().toString());
//        System.out.println();
    }//GEN-LAST:event_cur_dtFocusLost
    ...
    public void fgcheck(JTextField c ){
        ...
        if(str.equals("*Field is Mandatory")||str.equals("*Invalid Input")||str.equals("*Please enter a valid email Id!"))
        {
            c.setText("");
    ...
    public void keycheck(JTextField c,KeyEvent evt){
        char ch=evt.getKeyChar();
        if(evt.getKeyChar()==' '&& c.getCaretPosition()==0){
            evt.consume();
            Toolkit.getDefaultToolkit().beep();
        }
        else{
            if(c.equals(mail_tf)){
                if(evt.getKeyChar()==' '&&mail_tf.getCaretPosition()==0){
                    evt.consume();
                    Toolkit.getDefaultToolkit().beep();
                }
    ...
    public void Check(){
        ...
        flcheck(con_tf);
        flcheck(dist_tf);
        if(adds_tf.getText().equals("*Field is Mandatory")||adds_tf.getText().isEmpty())
            adds_tf.setBorder(new LineBorder(Color.RED));
    }
    public void refresh()
    {
        ...
        adds_tf.setForeground(Color.black);
        dist_tf.setBorder(new LineBorder(Color.BLACK));
        dist_tf.setForeground(Color.black);
...
//        cou_box.set
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstt="collapsed" desc=" Look and feel setting code (optional) ">
